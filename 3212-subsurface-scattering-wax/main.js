// 3212 - Subsurface Scattering Wax
// Simulates SSS for translucent wax/candle material
...
info.style.cssText = 'position:fixed;top:16px;left:16px;color:#ffaa77;font-family:monospace;font-size:13px;background:rgba(26,10,5,0.85);padding:12px;border-radius:8px'
info.innerHTML = '<b>Subsurface Scattering Wax</b><br>Candle with SSS shader<br>Drag to orbit'
