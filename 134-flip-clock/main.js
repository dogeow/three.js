import * as THREE from 'three';
    ...
    function createDigit(digitValue) {
      ...
      const topMat = new THREE.MeshStandardMaterial({
        ...
        roughness: 0.2,
        metalness: 0.1,
        emissive: new THREE.Color(s.digit).multiplyScalar(0.05),
      });
    ...
    function updateDigitDisplay(digitGroup, value, immediate = false) {
      ...
      d.topMesh.material.emissive.setHex(color).multiplyScalar(0.05);
      d.bottomMesh.material.emissive.setHex(color).multiplyScalar(0.05);
