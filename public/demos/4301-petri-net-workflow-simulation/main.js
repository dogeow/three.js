...
const places = [
  { id: 'received',  label: '已接收',  pos: [-8,  0, 0], tokens: 3 },
  { id: 'validated', label: '已验证', pos: [-2,  0, 0], tokens: 0 },
  { id: 'approved',  label: '已批准',  pos: [ 4,  0, 0], tokens: 0 },
  { id: 'shipped',   label: '已发货',   pos: [10,  0, 0], tokens: 0 },
  { id: 'paid',      label: '已支付',      pos: [ 4, -5, 0], tokens: 0 },
];

const transitions = [
  { id: 't_validate', label: '验证', pos: [-5,  0, 0] },
  { id: 't_approve',  label: '批准',  pos: [ 1,  0, 0] },
  { id: 't_ship',     label: '发货',     pos: [ 7,  0, 0] },
  { id: 't_pay',      label: '支付',      pos: [ 1, -3, 0] },
];
